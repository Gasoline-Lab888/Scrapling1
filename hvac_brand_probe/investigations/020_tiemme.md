...
- Alternative entry URLs: https://www.tiemme.com/
...
probe_notes:
  ...
  crawl_scope_notes: "爬产品目录中 manifolds、valves、fittings、PEX/multilayer、heating components；Chrome 搜索可补 m.tiemme.com/eng 产品页。
"
