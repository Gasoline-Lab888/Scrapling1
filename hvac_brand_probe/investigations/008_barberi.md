...
- Alternative entry URLs: https://www.barberi.it/
; https://www.barberi.it/ww/en/
...
probe_notes:
  ...
  crawl_scope_notes: "爬英文产品列表，重点 mixing units、manifolds、safety valves、balancing/shut-off valves、pump groups，PDF 从产品页收集。
"
